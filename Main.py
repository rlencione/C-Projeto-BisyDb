...
item_mel.grid(column=1, row=12, padx=10)
...
ata_mel.grid(column=2, row=12, padx=10)
...
cat_mel.grid(column=3, row=12, padx=10)

# Checkbuttons report
no_report = tk.IntVar()
yes_report = tk.IntVar()

check_repot = tk.Checkbutton(
    janela,
    text="NO REPORT",
    font = ("Arial", 12, "bold"),
    fg="white",
...
check_repot.grid(column=1, row=8)

# Checkbuttons pilot rep
crew_report = tk.IntVar()
crew_report = tk.IntVar()
